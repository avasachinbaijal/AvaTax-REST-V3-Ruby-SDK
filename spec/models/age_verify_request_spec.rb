...
describe AvalaraSdk::AgeVerification::AgeVerifyRequest do
  let(:instance) { AvalaraSdk::AgeVerification::AgeVerifyRequest.new }

  describe 'test an instance of AgeVerifyRequest' do
    it 'should create an instance of AgeVerifyRequest' do
      expect(instance).to be_instance_of(AvalaraSdk::AgeVerification::AgeVerifyRequest)
    end
  end
