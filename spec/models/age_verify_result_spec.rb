...
describe AvalaraSdk::AgeVerification::AgeVerifyResult do
  let(:instance) { AvalaraSdk::AgeVerification::AgeVerifyResult.new }

  describe 'test an instance of AgeVerifyResult' do
    it 'should create an instance of AgeVerifyResult' do
      expect(instance).to be_instance_of(AvalaraSdk::AgeVerification::AgeVerifyResult)
    end
  end
