...
describe AvalaraSdk::Shipping::ErrorDetailsError do
  let(:instance) { AvalaraSdk::Shipping::ErrorDetailsError.new }

  describe 'test an instance of ErrorDetailsError' do
    it 'should create an instance of ErrorDetailsError' do
      expect(instance).to be_instance_of(AvalaraSdk::Shipping::ErrorDetailsError)
    end
  end
