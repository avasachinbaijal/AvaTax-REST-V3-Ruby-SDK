...
describe AvalaraSdk::Shipping::ErrorDetailsErrorDetails do
  let(:instance) { AvalaraSdk::Shipping::ErrorDetailsErrorDetails.new }

  describe 'test an instance of ErrorDetailsErrorDetails' do
    it 'should create an instance of ErrorDetailsErrorDetails' do
      expect(instance).to be_instance_of(AvalaraSdk::Shipping::ErrorDetailsErrorDetails)
    end
  end
