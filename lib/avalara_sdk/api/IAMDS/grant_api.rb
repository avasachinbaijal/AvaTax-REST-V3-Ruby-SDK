...
module AvalaraSdk::IAMDS
  class GrantApi
    ...
    # @option opts [Grant] :grant 
    # @return [Grant]
    def create_grant(opts = {})
      data, _status_code, _headers = create_grant_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :x_correlation_id Correlation ID to pass into the method. Returned in any response.
    # @option opts [Grant] :grant 
    # @return [Array<(Grant, Integer, Hash)>] Grant data, response status code and response headers
    def create_grant_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GrantApi.create_grant ...'
      end
      # OAuth2 Scopes
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'grant'])

      # return_type
      return_type = opts[:debug_return_type] || 'Grant'
      ...
      new_options = opts.merge(
        :operation => :"GrantApi.create_grant",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GrantApi#create_grant\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_grant(grant_id, opts = {})
      delete_grant_with_http_info(grant_id, opts)
      nil
    end
    ...
    def delete_grant_with_http_info(grant_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GrantApi.delete_grant ...'
      end
      # OAuth2 Scopes
      required_scopes = 'iam avatax_api'
      # verify the required parameter 'grant_id' is set
      if @api_client.config.client_side_validation && grant_id.nil?
        fail ArgumentError, "Missing the required parameter 'grant_id' when calling GrantApi.delete_grant"
      end
      allowable_values = ["1.0.0"]
      if @api_client.config.client_side_validation && opts[:'avalara_version'] && !allowable_values.include?(opts[:'avalara_version'])
        fail ArgumentError, "invalid value for \"avalara_version\", must be one of #{allowable_values}"
      ...
      # resource path
      local_var_path = '/grants/{grant-id}'.sub('{' + 'grant-id' + '}', CGI.escape(grant_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"GrantApi.delete_grant",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GrantApi#delete_grant\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      if new_options[:return_type]
        data = deserialize(response, new_options[:return_type])
      else
    ...
    def get_grant(grant_id, opts = {})
      data, _status_code, _headers = get_grant_with_http_info(grant_id, opts)
      data
    end
    ...
    # @option opts [String] :if_none_match Only return the resource if the ETag is different from the ETag passed in.
    # @return [Array<(Grant, Integer, Hash)>] Grant data, response status code and response headers
    def get_grant_with_http_info(grant_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GrantApi.get_grant ...'
      end
      # OAuth2 Scopes
      required_scopes = 'iam avatax_api'
      # verify the required parameter 'grant_id' is set
      if @api_client.config.client_side_validation && grant_id.nil?
        fail ArgumentError, "Missing the required parameter 'grant_id' when calling GrantApi.get_grant"
      end
      allowable_values = ["1.0.0"]
      if @api_client.config.client_side_validation && opts[:'avalara_version'] && !allowable_values.include?(opts[:'avalara_version'])
        fail ArgumentError, "invalid value for \"avalara_version\", must be one of #{allowable_values}"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GrantApi#get_grant\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      if new_options[:return_type]
        data = deserialize(response, new_options[:return_type])
      else
    ...
    def list_grants_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GrantApi.list_grants ...'
      end
      # OAuth2 Scopes
      required_scopes = 'iam avatax_api'
      allowable_values = ["1.0.0"]
      ...
      new_options = opts.merge(
        :operation => :"GrantApi.list_grants",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      response = @api_client.call_api(:GET, local_var_path, new_options, required_scopes)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GrantApi#list_grants\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      if new_options[:return_type]
        data = deserialize(response, new_options[:return_type])
      else
    ...
    def patch_grant(grant_id, opts = {})
      patch_grant_with_http_info(grant_id, opts)
      nil
    end
    ...
    # @option opts [Grant] :grant 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def patch_grant_with_http_info(grant_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GrantApi.patch_grant ...'
      end
      # OAuth2 Scopes
      required_scopes = 'iam avatax_api'
      # verify the required parameter 'grant_id' is set
      if @api_client.config.client_side_validation && grant_id.nil?
        fail ArgumentError, "Missing the required parameter 'grant_id' when calling GrantApi.patch_grant"
      end
      allowable_values = ["1.0.0"]
      if @api_client.config.client_side_validation && opts[:'avalara_version'] && !allowable_values.include?(opts[:'avalara_version'])
        fail ArgumentError, "invalid value for \"avalara_version\", must be one of #{allowable_values}"
      ...
      new_options = opts.merge(
        :operation => :"GrantApi.patch_grant",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GrantApi#patch_grant\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      if new_options[:return_type]
        data = deserialize(response, new_options[:return_type])
      else
    ...
    # @option opts [Grant] :grant 
    # @return [nil]
    def replace_grant(grant_id, opts = {})
      replace_grant_with_http_info(grant_id, opts)
      nil
    end
    ...
    # @option opts [Grant] :grant 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def replace_grant_with_http_info(grant_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GrantApi.replace_grant ...'
      end
      # OAuth2 Scopes
      required_scopes = 'iam avatax_api'
      # verify the required parameter 'grant_id' is set
      if @api_client.config.client_side_validation && grant_id.nil?
        fail ArgumentError, "Missing the required parameter 'grant_id' when calling GrantApi.replace_grant"
      end
      allowable_values = ["1.0.0"]
      if @api_client.config.client_side_validation && opts[:'avalara_version'] && !allowable_values.include?(opts[:'avalara_version'])
        fail ArgumentError, "invalid value for \"avalara_version\", must be one of #{allowable_values}"
      ...
      new_options = opts.merge(
        :operation => :"GrantApi.replace_grant",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GrantApi#replace_grant\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      if new_options[:return_type]
        data = deserialize(response, new_options[:return_type])
      else
